      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="flex">
          <button
            onClick={gSignIn}
            type="submit"
            className="group mr-3 relative flex w-1/2 justify-center rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
          >
            Login with Google
          </button>
          <button
